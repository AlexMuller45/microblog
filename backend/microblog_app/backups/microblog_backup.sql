...
nginx-1142x650-1.png	13
z_f9f1a913.jpg	14
z_f9f1a913.jpg	15
sample_640×426.jpg	16
enhance_the_glow_of_elements_on_clothes_add_glowing_neon_elements_to_clothes_208592592.jpg	17
nginx-1142x650-1.png	18
sample_640×426.jpg	19
\.
...
"🚀 GoLang: Where simplicity meets performance! 🐹✨ #GoLang #Programming #PerformanceMatters" #GoLang	1	\N	321	21
23	1	\N	282	23
fb	1	\N	243	24
sdfsdf	1	{"/api/medias/10__4__2023-07-01 00.57.19.jpg"}	236	25
...
dfhdghdg	1	{/api/medias/15__z_f9f1a913.jpg}	226	29
wrgwrgwg	1	{/api/medias/17__enhance_the_glow_of_elements_on_clothes_add_glowing_neon_elements_to_clothes_208592592.jpg}	222	31
879	1	{/api/medias/18__nginx-1142x650-1.png}	217	32
кеоыкноыкно	1	\N	216	33
аи	1	{/api/medias/19__sample_640×426.jpg}	215	34
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	70	113
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	67	116
Привет, фитнес-любители! ️‍️️‍️ Сегодня я бы хотел поговорить о том, как искусственный интеллект и информационные технологии преобразуют нашу тренировку и помогают достичь желаемых результатов 	2	{"/api/medias/4__2023-07-01 00.57.19.jpg"}	323	10
sdgafgheh	1	{"/api/medias/5__2023-07-01 00.57.19.jpg","/api/medias/6__2023-07-01 00.57.19.jpg",/api/medias/7__GitLab_issue.png}	326	20
fgnfgj	1	{/api/medias/11__fb0194a52f41abe20e0ff0af29sj--kukly-i-igrushki-vyazanaya-pchelka.jpg}	235	26
rthjrj	1	{/api/medias/13__nginx-1142x650-1.png}	229	28
\n'\n'\n90-8-	1	{/api/medias/16__sample_640×426.jpg}	224	30
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	147	36
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	69	114
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	66	117
Самое замечательное в современной эпохе  это то, что ИИ и ИТ предлагают нам невероятные возможности для фитнеса. Возможности, которые ранее казались недостижимыми. Теперь мы можем использовать специальные сенсоры и умные трекеры, чтобы отслеживать нашу активность и прогресс. Это помогает нам быть более осознанными в тренировках и контролировать свое здоровье. ️	5	\N	323	11
"🚀 NGINX: The web server that powers the internet's speed and reliability! 🌐💨 #NGINX #WebHosting #Performance"	1	{/api/medias/7__GitLab_issue.png}	316	22
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	68	115
Привет, мир! Я использую YouBot, умную модель языка от You.com	1	\N	65	118
Когда-то нам приходилось полагаться только на наши ощущения и субъективные представления о тренировке. Но теперь у нас есть ИИ-ассистенты, которые помогают нам оптимизировать тренировочные программы. Они анализируют нашу активность, питание и даже сон, чтобы предложить нам наиболее эффективный подход. 	6	\N	323	12
Get ready to dive into the world of Python!	1	\N	326	13
\.
...
SELECT pg_catalog.setval('public.medias_tab_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.tweets_tab_id_seq', 118, true);
